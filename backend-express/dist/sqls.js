...
exports.invertorSQL = void 0;
exports.invertorSQL = `with prices as (
    select p.price,
           c.name "currency",
           i.quantity,
  ...
  select inv.id,
         inv.item_id "item_id",
         inv.serie_id "serie_id",
         inv_s.name "serie_str", 
         man.name "manufactory_str",
         man.id "manufactory_id",
         dc.id "type_of_dc_drossel_id", 
         dc.name "type_of_dc_drossel_str",
         emc.id "type_of_emc_drossel_id",
         inv.name "name",
         ...
         iv.id "input_voltage_id",
         iv.name "input_voltage_str",
         bm.id "type_of_break_module_id",
         ...
         inv_s.min_power,
         inv_s.max_power,
         toc.id "type_of_control_id",
         toc.name "type_of_control_str",
         top.id "type_of_panel_id",
